...
import { GraduationCap, CheckCircle2, Award, Download, TrendingUp, Clock, Target, FileText, Play, Lock, AlertTriangle } from "lucide-react";
...
export default function AdvancedCoursePage() {
  const [courseProgress] = useState(15);
  ...
  const modules = [
    {
      ...
      progress: 45,
      lessons: [
        { title: "Elliott Wave Theory", duration: "20 mins", completed: true },
        { title: "Harmonic Patterns (Gartley, Butterfly, Bat)", duration: "22 mins", completed: true },
        { title: "Advanced Fibonacci Techniques", duration: "18 mins", completed: false },
        { title: "Volume Profile Analysis", duration: "15 mins", completed: false },
        { title: "Multi-Timeframe Analysis", duration: "15 mins", completed: false }
      ],
      quiz: {
        questions: 20,
        passingScore: 80,
    ...
    },
    {
      ...
      progress: 0,
      lessons: [
        { title: "Order Flow and Market Makers", duration: "18 mins", completed: false },
        { title: "Smart Money Concepts", duration: "16 mins", completed: false },
        { title: "Supply and Demand Zones", duration: "15 mins", completed: false },
        { title: "Institutional Order Blocks", duration: "14 mins", completed: false },
        { title: "Liquidity Sweeps and Stop Hunts", duration: "12 mins", completed: false }
      ],
      quiz: {
        questions: 18,
        passingScore: 80,
    ...
    },
    {
      ...
      progress: 0,
      lessons: [
        { title: "Portfolio Risk Management", duration: "15 mins", completed: false },
        { title: "Correlation-Based Position Sizing", duration: "12 mins", completed: false },
        { title: "Kelly Criterion and Optimal F", duration: "10 mins", completed: false },
        { title: "Drawdown Management", duration: "12 mins", completed: false },
        { title: "Scaling In and Out of Positions", duration: "11 mins", completed: false }
      ],
      quiz: {
        questions: 15,
        passingScore: 85,
    ...
    },
    {
      ...
      progress: 0,
      lessons: [
        { title: "Designing a Trading System", duration: "20 mins", completed: false },
        { title: "Backtesting Methodologies", duration: "22 mins", completed: false },
        { title: "Forward Testing and Optimization", duration: "18 mins", completed: false },
        { title: "System Performance Metrics", duration: "15 mins", completed: false },
        { title: "Avoiding Curve Fitting", duration: "15 mins", completed: false }
      ],
      quiz: {
        questions: 20,
        passingScore: 80,
    ...
    },
    {
      ...
      progress: 0,
      lessons: [
        { title: "Scalping Techniques and Execution", duration: "25 mins", completed: false },
        { title: "Swing Trading Advanced Patterns", duration: "25 mins", completed: false },
        { title: "Carry Trade Strategies", duration: "20 mins", completed: false },
        { title: "News Trading and Event-Driven Setups", duration: "25 mins", completed: false },
        { title: "Hedging and Risk Mitigation", duration: "25 mins", completed: false }
      ],
      quiz: {
        questions: 25,
        passingScore: 80,
    ...
    },
    {
      ...
      progress: 0,
      lessons: [
        { title: "Building a Trading Business", duration: "15 mins", completed: false },
        { title: "Performance Analysis and Journaling", duration: "12 mins", completed: false },
        { title: "Tax Optimization for Traders", duration: "10 mins", completed: false },
        { title: "Scaling Capital and Prop Firms", duration: "13 mins", completed: false },
        { title: "Continuous Improvement Process", duration: "10 mins", completed: false }
      ],
      quiz: {
        questions: 15,
        passingScore: 85,
