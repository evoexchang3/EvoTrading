export const enGB = {
  ...
  'footer.sectionCustomer': 'Customer',
  'footer.sectionTrustSecurity': 'Trust & Security',
  
  // Footer - Link labels (Additional)
  'footer.technicalAnalysis': 'Technical Analysis',
  'footer.fundamentalAnalysis': 'Fundamental Analysis',
  'footer.tradingSignals': 'Trading Signals',
  'footer.marketHeatmap': 'Market Heatmap',
  'footer.accountTypes': 'Account Types',
  'footer.paymentMethods': 'Payment Methods',
  'footer.verification': 'Verification',
  'footer.tradingAdvice': 'Trading Advice',
  'footer.rateTable': 'Rate Table',
  'footer.regulatoryLicenses': 'Regulatory & Licences',
  'footer.safetyOfFunds': 'Safety of Funds',
  'footer.securityDataProtection': 'Security & Data Protection',
  'footer.platformStatus': 'Platform Status',
  'footer.complaintsDisputes': 'Complaints & Disputes',
  'footer.support247': '24/7 Customer Support',
  'footer.tradingPlatform': 'Trading Platform',
  'footer.platformDescription': 'Professional trading platform for forex, crypto, and commodities. Regulated and secure.',
  'footer.allRightsReserved': 'All rights reserved.',
  'footer.sslSecured': 'SSL Secured',
  'footer.gdprCompliant': 'GDPR Compliant',
  'footer.amlKycVerified': 'AML/KYC Verified',
