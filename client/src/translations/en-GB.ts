export const en_GB = {
  ...
  'tools.positionCalculator.riskRules.rule1.example': '  'tools.positionCalculator.riskRules.rule1.example': ''tools.positionCalculator.riskRules.rule1.example': 0,000 account → Max $200 risk per trade. If stopped out 5 times in a row, you\\',
  ...
  'tools.positionCalculator.faq.q6.answer': 'Fixed Fractional (recommended for most traders): Risk a fixed % of current account balance per trade. Example: 2% of   'tools.positionCalculator.faq.q6.answer': '0K = ,00 risk. Account grows to   'tools.positionCalculator.faq.q6.answer': '2K → 2% = ,40 risk. Position size scales with account automatically. Pros: Compounds gains, reduces risk on drawdowns. Cons: Slow growth initially. Fixed Ratio: Risk increases only after specific profit target (e.g., increase size by 1 lot per $5K profit). Example: 1 lot until   'tools.positionCalculator.faq.q6.answer': 'Fixed Fractional (recommended for most traders): Risk a fixed % of current account balance per trade. Example: 2% of 'tools.positionCalculator.faq.q6.answer': 0K = $200 risk. Account grows to 'tools.positionCalculator.faq.q6.answer': 2K → 2% = $240 risk. Position size scales with account automatically. Pros: Compounds gains, reduces risk on drawdowns. Cons: Slow growth initially. Fixed Ratio: Risk increases only after specific profit target (e.g., increase size by 1 lot per $5K profit). Example: 1 lot until 'tools.positionCalculator.faq.q6.answer': 5K, then 2 lots until $20K. Pros: Controlled growth. Cons: Complex to manage. For 95% of traders, use Fixed Fractional - it\\',
  ...
  'company.links.safety.description': 'How we protect your funds with segregated accounts',
  'company.links.rates.title': 'Rates & Fees',
  'company.links.rates.description': 'Transparent pricing and competitive trading conditions',
  'company.links.security.title': 'Platform Security',
  'company.links.security.description': 'Our security measures and data protection policies',
  ...
  'company.values.transparency.description': 'Clear pricing, honest communication, and full disclosure in all our operations',
  'company.values.security.title': 'Security First',
  ...
  'security.password.newLabel': 'New Password',
  'security.password.confirmLabel': 'Confirm New Password',
  'security.password.requirement': 'Password must be at least 8 characters long',
  'security.password.update': 'Update Password',
  'security.password.updating': 'Updating...',
  'security.password.successTitle': 'Password Updated',
  ...
  'security.twoFactor.statusEnabled': '2FA is currently enabled on your account',
  'security.twoFactor.statusDisabled': '2FA is currently disabled. Enable it for better security.',
  'security.twoFactor.howItWorks': 'How it works:',
  'security.twoFactor.step1': 'Download an authenticator app (Google Authenticator, Authy, etc.)',
  'security.twoFactor.step2': 'Scan the QR code with your app',
  'security.twoFactor.step3': 'Enter the 6-digit code when logging in',
  'security.twoFactor.enabledTitle': '2FA Enabled',
  ...
  'security.sessions.comingSoon': 'Session management coming soon',
};
