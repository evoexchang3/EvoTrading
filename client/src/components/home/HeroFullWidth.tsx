  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className={`${classes.container} relative ${classes.spacing('section')}`}>
        <div className={`mx-auto max-w-full ${classes.spacing('element')} ${classes.animation('hero')}`}>
          <h1 className={`${classes.textSize('hero')} font-bold tracking-tight`} data-testid="text-hero-title">
            {t('home.hero.title')}
          </h1>
          <p className={`${classes.textSize('body')} text-muted-foreground max-w-3xl`} data-testid="text-hero-subtitle">
