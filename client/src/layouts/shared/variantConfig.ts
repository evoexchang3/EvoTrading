  ...
  'bloomberg-dark': {
    ...
    pages: {
      home: {
        ...
        sectionOrder: ['hero', 'testimonials', 'stats', 'features', 'benefits', 'compliance', 'cta'],
      },
      about: {
        layout: 'values-first',
        teamPresentation: 'grid',
  ...
  'emerald-trader': {
    ...
    pages: {
      home: {
        ...
        includeLiveTicker: true,
        includeComplianceBadges: false,
        sectionOrder: ['hero', 'partners', 'stats', 'features', 'cta'],
      },
      about: {
        layout: 'timeline-led',
        teamPresentation: 'grid',
  ...
  'financial-times': {
    ...
    pages: {
      home: {
        ...
        includeLiveTicker: false,
        includeComplianceBadges: false,
        sectionOrder: ['hero', 'testimonials', 'features', 'benefits', 'stats', 'cta'],
      },
      about: {
        layout: 'team-first',
        teamPresentation: 'spotlight-list',
